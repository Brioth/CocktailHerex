...
/**
 * An activity representing a single Cocktail detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link CocktailListActivity}.
 */
public class CocktailDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putInt(CocktailDetailFragment.ARG_ITEM_ID,
                    getIntent().getIntExtra(CocktailDetailFragment.ARG_ITEM_ID,0));
